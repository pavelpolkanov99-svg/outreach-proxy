...
// - Added 1-line Hard Kill mandatory STOP reinforcement
// - Added 1-line brand recognition warning
// - All other discipline rules enforced in routes/parallel.js post-processor
//   and in skill v2.2 layer
//
function buildResearchQuery(company, domain) {
  return [
    ...
    `  3. Conservative by default. When in doubt, score lower. Brand recognition is NOT evidence — big company with vague stablecoin story scores P2, not P1.`,
    ...
    `  Axis 8 (Competitive Proximity): 9–10 pure client/partner; 7–8 minimal overlap; 5–6 partial competitor BUT angle exists; 3–4 significant overlap; 1–2 direct competitor on clearing/settlement. If company builds the same primary product (stablecoin clearing for FIs — Brale, Bridge, Nodu, AlphaPoint, Conduit), max 6.`,
    ``,
